...
from maskinversion import MaskInversion, MaskInversionImagePreprocess, MaskInversionMaskPreprocess, overlay_image_mask, overlay_image_expl_map
...
localized_embeddings, expl_map = model.compute_maskinversion(image=image, masks_target=masks, verbose=True, return_expl_map=True)  # [num_masks, dim]
